...
export default class MeteorScreen extends Component {
 ...
 <View style = {styles.gifConatiner}>
...
Closest To The Earth - {item.close_approach_data[0].close_approach_data_full} 
</Text>
<Text style = {[styles.cardTitle, {marginTop: 5, marginLeft: 50}]}>
Minimum Diameter (Kilometer) - {item.estimated_diameter.kilometers.estimated_diameter_min}
</Text>
<Text style = {[styles.cardTitle, {marginTop: 5, marginLeft: 50}]}>
Maximim Diameter (kilometers) - {item.estimated_diameter.kilometers.estimated_diameter_max}
</Text>
<Text style = {[styles.cardTitle, {marginTop: 5, marginLeft: 50}]}>
